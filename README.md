...
* [HugeGraph](https://github.com/hugegraph/hugegraph) ⭐ 27 | 🐛 46 | 🌐 Java | 📅 2026-09-25 - An open source TinkerPop 3 compliant OLTP Graph Database with pluggable storage bakcend which is similar to JanusGraph. It also supports OLAP through Spark GraphX.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,955 | 🐛 153 | 🌐 Rust | 📅 2026-09-24 - a light wight triple store written in Rust.
* [CLever](https://github.com/ad-freiburg/qlever) ⭐ 906 | 🐛 411 | 🌐 C++ | 📅 2026-09-25 - a SPARQL engine that can efficiently index and query very large knowledge graphs with over 100 billion triples on a single standard PC or server
...
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,559 | 🐛 377 | 🌐 Python | 📅 2026-09-25 - Cloud accounts for Graphistry end-to-end GPU-accelerated visual graph analytics projects
...
* [Dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,515 | 🐛 92 | 🌐 Python | 📅 2025-07-29 - dedupe is a python library that uses machine learning to perform fuzzy matching, deduplication and entity resolution quickly on structured data.
...
* [awesome-knowledge-graph](https://github.com/husthuke/awesome-knowledge-graph) ⭐ 5,165 | 🐛 8 | 📅 2021-03-11 - Knowledge graph related materials but all in Chinese
