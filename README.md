...
* [Cayley](https://github.com/cayleygraph/cayley) ⭐ 15,061 | 🐛 93 | 🌐 Go | 📅 2026-08-17 - open source database written in Go
...
* [HugeGraph](https://github.com/hugegraph/hugegraph) ⭐ 26 | 🐛 32 | 🌐 Java | 📅 2026-08-25 - An open source TinkerPop 3 compliant OLTP Graph Database with pluggable storage bakcend which is similar to JanusGraph. It also supports OLAP through Spark GraphX.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,836 | 🐛 149 | 🌐 Rust | 📅 2026-08-24 - a light wight triple store written in Rust.
* [CLever](https://github.com/ad-freiburg/qlever) ⭐ 886 | 🐛 391 | 🌐 C++ | 📅 2026-08-22 - a SPARQL engine that can efficiently index and query very large knowledge graphs with over 100 billion triples on a single standard PC or server
...
* [Dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,506 | 🐛 90 | 🌐 Python | 📅 2025-07-29 - dedupe is a python library that uses machine learning to perform fuzzy matching, deduplication and entity resolution quickly on structured data.
