...
* [Cayley](https://github.com/cayleygraph/cayley) ⭐ 15,058 | 🐛 93 | 🌐 Go | 📅 2026-08-17 - open source database written in Go
...
* [HugeGraph](https://github.com/hugegraph/hugegraph) ⭐ 26 | 🐛 28 | 🌐 Java | 📅 2026-08-18 - An open source TinkerPop 3 compliant OLTP Graph Database with pluggable storage bakcend which is similar to JanusGraph. It also supports OLAP through Spark GraphX.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,824 | 🐛 145 | 🌐 Rust | 📅 2026-08-18 - a light wight triple store written in Rust.
* [CLever](https://github.com/ad-freiburg/qlever) ⭐ 884 | 🐛 378 | 🌐 C++ | 📅 2026-08-18 - a SPARQL engine that can efficiently index and query very large knowledge graphs with over 100 billion triples on a single standard PC or server
...
* [AntV G6](https://github.com/antvis/g6) ⭐ 12,258 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - Simple, easy and complete high performance graph visualization engine written in JavaScript, from Ant Financial
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,551 | 🐛 361 | 🌐 Python | 📅 2026-08-18 - An end-to-end GPU visual graph analytics engine (Nvidia RAPIDS.ai / Apache Arrow) with interfaces including JS/React, Python (Jupyter/StreamLit), REST, rich no-code/low-code UIs for various databases, and self + cloud hosting, from Graphistry.
...
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,551 | 🐛 361 | 🌐 Python | 📅 2026-08-18 - Cloud accounts for Graphistry end-to-end GPU-accelerated visual graph analytics projects
...
* [Dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,502 | 🐛 90 | 🌐 Python | 📅 2025-07-29 - dedupe is a python library that uses machine learning to perform fuzzy matching, deduplication and entity resolution quickly on structured data.
