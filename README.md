...
* [HugeGraph](https://github.com/hugegraph/hugegraph) ⭐ 27 | 🐛 44 | 🌐 Java | 📅 2026-09-24 - An open source TinkerPop 3 compliant OLTP Graph Database with pluggable storage bakcend which is similar to JanusGraph. It also supports OLAP through Spark GraphX.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,953 | 🐛 153 | 🌐 Rust | 📅 2026-09-24 - a light wight triple store written in Rust.
* [CLever](https://github.com/ad-freiburg/qlever) ⭐ 906 | 🐛 404 | 🌐 C++ | 📅 2026-09-24 - a SPARQL engine that can efficiently index and query very large knowledge graphs with over 100 billion triples on a single standard PC or server
...
* [AntV G6](https://github.com/antvis/g6) ⭐ 12,307 | 🐛 333 | 🌐 TypeScript | 📅 2026-09-23 - Simple, easy and complete high performance graph visualization engine written in JavaScript, from Ant Financial
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,557 | 🐛 375 | 🌐 Python | 📅 2026-09-23 - An end-to-end GPU visual graph analytics engine (Nvidia RAPIDS.ai / Apache Arrow) with interfaces including JS/React, Python (Jupyter/StreamLit), REST, rich no-code/low-code UIs for various databases, and self + cloud hosting, from Graphistry.
...
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,557 | 🐛 375 | 🌐 Python | 📅 2026-09-23 - Cloud accounts for Graphistry end-to-end GPU-accelerated visual graph analytics projects
