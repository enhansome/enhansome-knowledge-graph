...
* [HugeGraph](https://github.com/hugegraph/hugegraph) ⭐ 27 | 🐛 39 | 🌐 Java | 📅 2026-09-12 - An open source TinkerPop 3 compliant OLTP Graph Database with pluggable storage bakcend which is similar to JanusGraph. It also supports OLAP through Spark GraphX.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,877 | 🐛 151 | 🌐 Rust | 📅 2026-09-12 - a light wight triple store written in Rust.
* [CLever](https://github.com/ad-freiburg/qlever) ⭐ 899 | 🐛 407 | 🌐 C++ | 📅 2026-09-12 - a SPARQL engine that can efficiently index and query very large knowledge graphs with over 100 billion triples on a single standard PC or server
...
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,555 | 🐛 377 | 🌐 Python | 📅 2026-09-12 - Cloud accounts for Graphistry end-to-end GPU-accelerated visual graph analytics projects
...
* [Dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,512 | 🐛 92 | 🌐 Python | 📅 2025-07-29 - dedupe is a python library that uses machine learning to perform fuzzy matching, deduplication and entity resolution quickly on structured data.
