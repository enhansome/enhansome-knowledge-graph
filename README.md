...
* [Cayley](https://github.com/cayleygraph/cayley) ⭐ 15,064 | 🐛 93 | 🌐 Go | 📅 2026-08-27 - open source database written in Go
...
* [HugeGraph](https://github.com/hugegraph/hugegraph) ⭐ 27 | 🐛 40 | 🌐 Java | 📅 2026-09-17 - An open source TinkerPop 3 compliant OLTP Graph Database with pluggable storage bakcend which is similar to JanusGraph. It also supports OLAP through Spark GraphX.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,912 | 🐛 152 | 🌐 Rust | 📅 2026-09-15 - a light wight triple store written in Rust.
* [CLever](https://github.com/ad-freiburg/qlever) ⭐ 903 | 🐛 402 | 🌐 C++ | 📅 2026-09-17 - a SPARQL engine that can efficiently index and query very large knowledge graphs with over 100 billion triples on a single standard PC or server
...
* [AntV G6](https://github.com/antvis/g6) ⭐ 12,298 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - Simple, easy and complete high performance graph visualization engine written in JavaScript, from Ant Financial
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,555 | 🐛 372 | 🌐 Python | 📅 2026-09-17 - An end-to-end GPU visual graph analytics engine (Nvidia RAPIDS.ai / Apache Arrow) with interfaces including JS/React, Python (Jupyter/StreamLit), REST, rich no-code/low-code UIs for various databases, and self + cloud hosting, from Graphistry.
...
* [Morph-KGC](https://github.com/morph-kgc/morph-kgc/) ⭐ 290 | 🐛 32 | 🌐 Python | 📅 2026-06-28 - Knowledge graph generation system with RML mappings.
...
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,555 | 🐛 372 | 🌐 Python | 📅 2026-09-17 - Cloud accounts for Graphistry end-to-end GPU-accelerated visual graph analytics projects
...
* [Dedupe](https://github.com/dedupeio/dedupe) ⭐ 4,510 | 🐛 92 | 🌐 Python | 📅 2025-07-29 - dedupe is a python library that uses machine learning to perform fuzzy matching, deduplication and entity resolution quickly on structured data.
...
* [awesome-knowledge-graph](https://github.com/husthuke/awesome-knowledge-graph) ⭐ 5,157 | 🐛 8 | 📅 2021-03-11 - Knowledge graph related materials but all in Chinese
* [awesome-graph](https://github.com/jbmusso/awesome-graph) ⭐ 1,273 | 🐛 17 | 📅 2026-02-26 - Graph, the infrastructure for Knowledge Graph
