...
* [Cayley](https://github.com/cayleygraph/cayley) ⭐ 15,058 | 🐛 93 | 🌐 Go | 📅 2026-07-22 - open source database written in Go
...
* [HugeGraph](https://github.com/hugegraph/hugegraph) ⭐ 26 | 🐛 31 | 🌐 Java | 📅 2026-08-12 - An open source TinkerPop 3 compliant OLTP Graph Database with pluggable storage bakcend which is similar to JanusGraph. It also supports OLAP through Spark GraphX.
...
* [Oxigraph](https://github.com/oxigraph/oxigraph) ⭐ 1,813 | 🐛 141 | 🌐 Rust | 📅 2026-08-12 - a light wight triple store written in Rust.
* [CLever](https://github.com/ad-freiburg/qlever) ⭐ 880 | 🐛 379 | 🌐 C++ | 📅 2026-08-11 - a SPARQL engine that can efficiently index and query very large knowledge graphs with over 100 billion triples on a single standard PC or server
...
* [AntV G6](https://github.com/antvis/g6) ⭐ 12,246 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - Simple, easy and complete high performance graph visualization engine written in JavaScript, from Ant Financial
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,549 | 🐛 340 | 🌐 Python | 📅 2026-08-13 - An end-to-end GPU visual graph analytics engine (Nvidia RAPIDS.ai / Apache Arrow) with interfaces including JS/React, Python (Jupyter/StreamLit), REST, rich no-code/low-code UIs for various databases, and self + cloud hosting, from Graphistry.
...
* [Graphistry](https://github.com/graphistry/pygraphistry) ⭐ 2,549 | 🐛 340 | 🌐 Python | 📅 2026-08-13 - Cloud accounts for Graphistry end-to-end GPU-accelerated visual graph analytics projects
...
* [awesome-knowledge-graph](https://github.com/husthuke/awesome-knowledge-graph) ⭐ 5,150 | 🐛 8 | 📅 2021-03-11 - Knowledge graph related materials but all in Chinese
